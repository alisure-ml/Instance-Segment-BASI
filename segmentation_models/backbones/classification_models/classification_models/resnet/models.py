from .builder import build_resnet, build_resnet_2
...
def ResNet18_2(input_shape, input_tensor=None, weights=None, classes=1000, include_top=True, output_num=None):
    model = build_resnet_2(input_tensor=input_tensor,
                           input_shape=input_shape,
                           repetitions=(2, 2, 2, 2),
                           classes=classes,
                           include_top=include_top,
                           block_type='basic', output_num=output_num)
    model.name = 'resnet18'
...
def ResNet34_2(input_shape, input_tensor=None, weights=None, classes=1000, include_top=True):
    model = build_resnet_2(input_tensor=input_tensor,
                         input_shape=input_shape,
                         repetitions=(3, 4, 6, 3),
                         classes=classes,
