...
def PyramidPoolingModule(**params):
    ...
    def module(input_tensor):
        ...
        x1 = InterpBlock(1, feature_map_shape, **_params)(input_tensor)
        x2 = InterpBlock(2, feature_map_shape, **_params)(input_tensor)
        x4 = InterpBlock(4, feature_map_shape, **_params)(input_tensor)
        x8 = InterpBlock(8, feature_map_shape, **_params)(input_tensor)
        x16 = InterpBlock(16, feature_map_shape, **_params)(input_tensor)
        x32 = InterpBlock(32, feature_map_shape, **_params)(input_tensor)
        x64 = InterpBlock(64, feature_map_shape, **_params)(input_tensor)
        x = Concatenate()([input_tensor, x1, x2, x4, x8, x16, x32, x64])
