...
if __name__ == '__main__':
    ...
    is_class = True
    if is_class:
        save_dir = "./output/segment_class/{}/{}_s".format(which_image, which_image)
        ...
        save_dir = "./output/segment_class/{}/{}_ss".format(which_image, which_image)
        inference = Inference(input_size=[720, 720], summary_dir=save_dir, log_dir="./model/segment_side/720")
