...
class Train(object):
    ...
    def __init__(self, batch_size, input_size, log_dir, data_root_path, train_list, data_path,
        ...
        self.cal_step = self.data_reader.number_patch
        self.print_step = self.cal_step // 10
    ...
    def cal_loss(segments, label_segment):
        ...
        for segment_index, segment in enumerate(segments):
            # if "segment_side" not in segments[0].name:
            #     continue
...
if __name__ == '__main__':
    ...
    Train(batch_size=2, input_size=[480, 480], log_dir="./model/segment_add/480",
